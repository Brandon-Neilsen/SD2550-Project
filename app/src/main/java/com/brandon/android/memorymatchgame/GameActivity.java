...
public class GameActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        mValueOptions.add("Washington");
        mValueOptions.add("Gabriel");
        mValueOptions.add("Abraham");
        mValueOptions.add("Steve");
        mValueOptions.add("Miranda");
        mValueOptions.add("Ashley");
        mValueOptions.add("Courtney");
        mValueOptions.add("Rachel");
        mValueOptions.add("Melynda");
